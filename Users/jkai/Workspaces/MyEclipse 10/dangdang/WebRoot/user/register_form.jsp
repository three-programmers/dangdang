...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/registValidate.js"></script>
	</head>
	<body>
		...
		<div class="fill_message">
			<form name="ctl00" method="post" action="../user/register.do" id="f">
				<h2>
					以下均为必填项
				</h2>
				<table class="tab_login" >
					...
					<tr>
						...
						<td>
							<img class="yzm_img" id='imgVcode' src="../imag/creatImag.do" />
