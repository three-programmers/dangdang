	...
	<div class="head_welcome">
		<div class="head_welcome_right">
			...
			<span class="head_welcome_text"> <span class="little_n">
					| <a href="../user/showOrders.do?pageIndex=1" name="mydangdang" class="head_black12a">我的当当</a> | <a
					href="#" name="helpcenter" class="head_black12a" target="_blank">帮助</a>
					| </span> </span>
			<div class="cart gray4012">
				<a href="../cart/showCart.do">购物车</a>
			</div>
		</div>
		<span class="head_toutext" id="logininfo">
		<b>${sessionScope.user.name}您好，欢迎光临当当网</b>
		
		<c:if test="${sessionScope.user.name != null}">
			[&nbsp;<a href="../user/logout.do" class="b">登出</a>&nbsp;]
		</c:if>
		<c:if test="${sessionScope.user.name == null}">
