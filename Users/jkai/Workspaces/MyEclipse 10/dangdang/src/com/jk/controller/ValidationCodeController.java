...
public class ValidationCodeController{
	...
	@RequestMapping("/creatImag")
	public void creatImag(HttpServletRequest request,HttpServletResponse response) throws Exception {
		init();
	...
	@RequestMapping("/checkImag")
	public @ResponseBody boolean checkImag(String number,HttpServletRequest request) throws Exception{
		HttpSession session = request.getSession();
		String validationCode = (String)session.getAttribute("validationCode");
		if(validationCode.equals(number)){
			return true;
		}else{
			return false;
		}
